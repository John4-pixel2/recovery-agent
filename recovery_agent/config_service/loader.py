...
def load_raw_config() -> Dict[str, Any]:
    ...
    Der Pfad wird über die Umgebungsvariable 'CONFIG_PATH' bestimmt,
    mit 'config.yaml' als Standard.
    ...
    """
    config_path_str = os.getenv("CONFIG_PATH", "config.yaml")
    ...
    try:
        ...
        if not isinstance(raw_config, dict):
            raise ConfigFileError(f"Die Konfigurationsdatei '{config_path_str}' muss ein YAML-Mapping (Dictionary) sein.")
        return raw_config
