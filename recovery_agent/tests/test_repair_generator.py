...
from recovery_agent.self_repair.repair_generator import (
    ...
    PermissionErrorRule,
    RuleRegistry,
    RepairRule,  # Import the base class for testing purposes
)
from typing import Optional


# A helper class for tests that always matches.
class CatchAllRule(RepairRule):
    """A test rule that always matches and generates a generic script."""
...
def registry() -> RuleRegistry:
    """Provides a RuleRegistry instance with standard rules registered."""
    reg = RuleRegistry()
